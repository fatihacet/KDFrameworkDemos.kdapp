// Compiled by Koding Servers at Thu Jun 06 2013 06:35:45 GMT-0700 (PDT) in server time

(function() {

/* KDAPP STARTS */

/* BLOCK STARTS /Source: /Users/fatihacet/Applications/KDFrameworkDemos.kdapp/internal/kdaccordionpanehandle.coffee */

var KDAccordionPaneHandle,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

KDAccordionPaneHandle = (function(_super) {
  __extends(KDAccordionPaneHandle, _super);

  function KDAccordionPaneHandle(options, data) {
    if (options == null) {
      options = {};
    }
    options.tagName = "span";
    options.cssClass = "kdaccordionhandle";
    KDAccordionPaneHandle.__super__.constructor.call(this, options, data);
    ...
    this.title = new KDCustomHTMLView({
      ...
      partial: this.getOptions().title
    });
  }

  KDAccordionPaneHandle.prototype.pistachio = function() {
    return "{{> this.icon}}\n{{> this.title}}";
  };

  return KDAccordionPaneHandle;
...
/* BLOCK STARTS /Source: /Users/fatihacet/Applications/KDFrameworkDemos.kdapp/internal/kdaccordionpane.coffee */

var KDAccordionPane,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

KDAccordionPane = (function(_super) {
  __extends(KDAccordionPane, _super);

  function KDAccordionPane(options, data) {
    var HandleClass, childView,
      _this = this;
    ...
    KDAccordionPane.__super__.constructor.call(this, options, data);
    HandleClass = this.getOptions().paneHandleClass || KDAccordionPaneHandle;
    this.handle = new HandleClass({
      title: this.getOptions().handleTitle,
      click: function() {
        var delegate;

        delegate = _this.getDelegate() || _this.parent;
        return delegate.emit("KDAccordionHandleClicked", _this);
      }
    });
    this.paneContainer = new KDView({
      cssClass: "kdaccordionpane"
    });
    childView = this.getOptions().childView;
    if (childView && childView instanceof KDView) {
      this.paneContainer.addSubView(this.pane = childView);
    } else {
      this.paneContainer.addSubView(this.pane = new KDView({
        partial: this.getOptions().partial
      }));
    }
  }

  KDAccordionPane.prototype.pistachio = function() {
    return "{{> this.handle}}\n{{> this.paneContainer}}";
  };

  return KDAccordionPane;
...
/* BLOCK STARTS /Source: /Users/fatihacet/Applications/KDFrameworkDemos.kdapp/internal/kdaccordionview.coffee */

var KDAccordionView,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

KDAccordionView = (function(_super) {
  __extends(KDAccordionView, _super);

  function KDAccordionView(options, data) {
    var _this = this;
    ...
    KDAccordionView.__super__.constructor.call(this, options, data);
    this.panes = [];
    this.visiblePanes = [];
    this.activePaneIndex = 0;
    this.on("KDAccordionHandleClicked", function(paneInstance) {
      if (_this.isPaneVisible(paneInstance)) {
        _this.hidePane(paneInstance);
        return _this.visiblePanes.splice(_this.visiblePanes.indexOf(paneInstance, 1));
      } else {
        _this.showPane(paneInstance);
        return _this.visiblePanes.push(paneInstance);
      }
    });
  }

  KDAccordionView.prototype.addPane = function(paneInstance) {
    if (!(paneInstance instanceof KDAccordionPane)) {
      return;
    }
    this.panes.push(paneInstance);
    this.addSubView(paneInstance);
    return paneInstance.pane.hide();
  };

  KDAccordionView.prototype.addPanes = function(arrayOfPaneInstances) {
    var paneInstance, _i, _len, _results;

    if (!Array.isArray(arrayOfPaneInstances)) {
      return;
    }
    _results = [];
    for (_i = 0, _len = arrayOfPaneInstances.length; _i < _len; _i++) {
      paneInstance = arrayOfPaneInstances[_i];
      _results.push(this.addPane(paneInstance));
    }
    return _results;
  };

  KDAccordionView.prototype.showPane = function(paneInstance) {
    paneInstance.pane.show();
    return paneInstance.handle.setClass("active");
  };

  KDAccordionView.prototype.hidePane = function(paneInstance) {
    paneInstance.pane.hide();
    return paneInstance.handle.unsetClass("active");
  };

  KDAccordionView.prototype.getActivePane = function() {
    return this.panes[this.activePaneIndex];
  };

  KDAccordionView.prototype.getPaneInstanceByHandle = function(handle) {
    var pane, _i, _len, _ref;

    _ref = this.panes;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      pane = _ref[_i];
      if (pane && pane.handle === handle) {
        return pane;
      }
    }
  };

  KDAccordionView.prototype.isPaneVisible = function(pane) {
    return this.visiblePanes.indexOf(pane) > -1;
  };

  KDAccordionView.prototype.viewAppended = function() {
    KDAccordionView.__super__.viewAppended.apply(this, arguments);
    return this.prepareActivePane();
  };

  KDAccordionView.prototype.prepareActivePane = function(activePane) {
    if (activePane == null) {
      activePane = this.getActivePane();
    }
    activePane.pane.show();
    activePane.handle.setClass("active");
    return this.visiblePanes.push(activePane);
  };

  return KDAccordionView;
...
/* BLOCK STARTS /Source: /Users/fatihacet/Applications/KDFrameworkDemos.kdapp/kodepad/app/settings.coffee */
...
/* BLOCK STARTS /Source: /Users/fatihacet/Applications/KDFrameworkDemos.kdapp/kodepad/app/core.coffee */
...
/* BLOCK STARTS /Source: /Users/fatihacet/Applications/KDFrameworkDemos.kdapp/kodepad/app/views.coffee */
...
/* BLOCK STARTS /Source: /Users/fatihacet/Applications/KDFrameworkDemos.kdapp/app/data.coffee */

var KDFrameworkDemosCode, KDFrameworkDemosData;

KDFrameworkDemosData = {
  KDTabView: [
    {
      thumbnail: "http://lorempixel.com/120/90/sports/9",
      title: "Basic KDTabView",
      description: "KDTabView: 101, basic tab view with 3 tabs",
      map: "tabBasic"
    }, {
      thumbnail: "http://lorempixel.com/120/90/sports/8",
      title: "Basic KDTabView",
      description: "KDTabView: 101, basic tab view with 3 tabs"
    }
  ],
  KDModalView: [
    {
      thumbnail: "http://lorempixel.com/120/90/sports/7",
      title: "Basic KDTabView",
      description: "KDTabView: 101, basic tab view with 3 tabs"
    }, {
...
KDFrameworkDemosCode = {
  tabBasic: "tab = new KDTabView()\ntab.addPane",
  siksiki: "new KDView({partial: 'saddsa'})"
};
...
/* BLOCK STARTS /Source: /Users/fatihacet/Applications/KDFrameworkDemos.kdapp/app/view.coffee */

var KDFrameworkDemoItem, KDFrameworkDemosView,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

KD.enableLogs();

KDFrameworkDemosView = (function(_super) {
  __extends(KDFrameworkDemosView, _super);

  function KDFrameworkDemosView(options, data) {
    var childView, item, pane, topic, _i, _len, _ref;

    if (options == null) {
      options = {};
    }
    options.cssClass = "kdframeworkdemos";
    KDFrameworkDemosView.__super__.constructor.call(this, options, data);
    this.accordionView = new KDAccordionView;
    data = this.getData();
    for (topic in data) {
      ...
      this.accordionView.addPane(pane = new KDAccordionPane({
        handleTitle: topic,
        childView: childView
      }));
    }
  ...
  KDFrameworkDemosView.prototype.pistachio = function() {
    return "{{> this.accordionView}}";
  };

  return KDFrameworkDemosView;

})(JView);

KDFrameworkDemoItem = (function(_super) {
  __extends(KDFrameworkDemoItem, _super);

  function KDFrameworkDemoItem(options, data) {
    var _this = this;
    ...
    KDFrameworkDemoItem.__super__.constructor.call(this, options, data);
    this.thumbnail = new KDCustomHTMLView({
      tagName: "img",
      attributes: {
        src: this.getData().thumbnail
      },
      click: function() {
        var ace;

        _this.getDelegate().hide();
        ace = _this.getDelegate().getOptions().kodepad.ace;
        return ace.setValue("appView.addSubView new KDView({\n  partial: \"Hello World!\"\n})");
      }
    });
    ...
    this.description = new KDView({
      partial: this.getData().description
    });
  }

  KDFrameworkDemoItem.prototype.pistachio = function() {
    return "{{> this.thumbnail}}\n{{> this.header}}\n{{> this.description}}";
  };

  return KDFrameworkDemoItem;
...
/* BLOCK STARTS /Source: /Users/fatihacet/Applications/KDFrameworkDemos.kdapp/index.coffee */
...
require(["ace/ace"], function(Ace) {
  ...
  return kdFwDemosView.setOption("kodepad", kodepad);
});
